 ...
 * DevolucionCabecera entities. Transaction control of the save(), update() and
 * delete() operations can directly support Spring container-managed
 * transactions or they can be augmented to handle user-managed Spring
 * transactions. Each of these methods provides additional information for how
 * to configure it for the desired type of transaction control.
 * 
 * @see DevolucionCabecera
 */
...
public class DevolucionCabeceraDao extends HibernateDaoImpl<DevolucionCabecera, Integer>
	...
	public static IDevolucionCabeceraDao getFromApplicationContext(ApplicationContext ctx) {
		return (IDevolucionCabeceraDao) ctx.getBean("DevolucionCabeceraDao");
	}
}
